```markdown name=README.md url=https://github.com/leeticiadiasds-byte/PENSAMENTO-COMPUTACIONAL-/blob/9e66c41c11cb56f6dac5be1f9905497fd5031692/Projeto/README.md
...
> **Nota:** Esse README serve como modelo base. Os alunos podem adaptá-lo conforme o sistema escolhido (e-commerce, rede social, sistema de transporte, etc.).
```
